...
function selectedOption (value: any, options: any) {
  let items = ''
...
app.get('/nuevoProducto', (req, res) => {
  res.render('nuevoProducto', {producto: {id: undefined, title: '', price: 0, thumbnail: ''}, imagenes, selectedOption })
})

app.get('/editarProducto/:id', (req, res) => {
  res.render('editarProducto', { producto: producto.getOne(+req.params.id), imagenes, selectedOption })
})
